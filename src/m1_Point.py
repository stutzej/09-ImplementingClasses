...
#  (continued)  in file  m0_INSTRUCTIONS.txt, asking questions as needed.
#
...
class Point(object):
    ...
    def move_to(self, dx, dy):
        ...
        self.distance = self.get_distance_from(initial) + self.distance
    ...
    def get_distance_from_start(self):
        p = Point(self.original_x, self.original_y)
